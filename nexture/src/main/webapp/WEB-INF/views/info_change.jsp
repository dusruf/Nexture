			...
			<form action="info_change" method="POST">
				<table style="border: 2px;">
					<tr>
						...
						<th>社員番号</th>
						<td><input class="bg" name="EM_number"type="text" value="${employee.EM_number }"
					...
					<tr>
						<th>職責</th>
						<td><input class="bg" type="text" name="hire_position"
							value="${employee.hire_position}" readonly="readonly" size="4"></td>
					<tr>
						<th>雇用形態</th>
						<td><input class="bg" type="text" name="hire_type"
   						value="${employee.hire_type}" readonly="readonly" size="7">
						</td>
					</tr>
				</table>
